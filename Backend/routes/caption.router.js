...
router.post("/register" , [
    ...
    body("vehical.color").isLength({max:3}).withMessage("Color must be at least 3 charater"),
    body("vehical.plate").isLength({max:3}).withMessage("Plate must be at least 3 charecter"),
    body("vehical.capacity").isLength({max:1}).withMessage("Capacity must be at least 1"),
